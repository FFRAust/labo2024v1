...
FE_historia_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/541_FE_historia_EPIC.r"
...
ZZ_final_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$kaggle$envios_desde <- 11500L
  param_local$kaggle$envios_hasta <- 15500L
