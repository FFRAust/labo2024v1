# Gráfico de la ganancia que visualiza el overfitting
# La idea es probar con distintos hiperparámetros del árbol de decisión
# y ver cómo se acercan o separan las curvas de ganancia
