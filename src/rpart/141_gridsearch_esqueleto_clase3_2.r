...
PARAM$semillas <- c(200041, 300043, 400051, 500083, 600091)
...
archivo_salida_clase3_2 <- "./exp/HT2020/gridsearch_clase3_2.txt"
...
for (vcp in c(-0.9)) {
  for (vmax_depth in c(13)){ 
    for (vmin_split in c(800)){
      for (vmin_bucket in c(240)){
