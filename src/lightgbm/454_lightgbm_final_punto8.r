...
PARAM$finalmodel$num_iterations <- 1516
PARAM$finalmodel$learning_rate <- 0.0101245873164644
PARAM$finalmodel$feature_fraction <- 0.801309971304579
PARAM$finalmodel$min_data_in_leaf <- 922
